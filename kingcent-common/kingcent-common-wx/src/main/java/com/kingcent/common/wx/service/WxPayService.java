...
public class WxPayService {
    ...
    public JSONObject checkOrder(String orderNo){
        ...
        try {
            ...
            ResponseEntity<String> exchange = restTemplate.exchange(WxConfig.MCH_BASE_URL + api, HttpMethod.GET, request, String.class);
    ...
    public WxPaymentInfoVo requestToPay(
        ...
        String res = restTemplate.postForObject(WxConfig.MCH_BASE_URL +WX_PAYMENT_API, formEntity, String.class);
        try {
